...
{
    public class Tests_DuoSignatureV4(ITestOutputHelper output)
    {
        ...
        private static readonly DuoSignatureV4 INSTANCE = new(TEST_IKEY, TEST_SKEY, TEST_HOST, TEST_TIME);
        ...
        {
            Assert.Equal(DuoSignatureTypes.Duo_SignatureTypeV4, INSTANCE.SignatureType);
        }
        ...
        public void Test_Signature()
        {
            ...
            var testSign = INSTANCE._GenerateSignature(HttpMethod.Post, "/Foo/BaR2/qux", TEST_TIME, new DuoJsonRequestDataObject(TEST_JSONOBJECT));
        ...
        {
            const string expectedResult = "dGVzdF9pa2V5OjIxNmVmMjE5OTY5MzY5MzZkMGZiYzQ4NDc3N2Q0ZjRmMWIzYTE4YjUyZjY1ZDk5MmIwMmRkZmJhYWFlZTRiNWZkMTA0NGMzNDk3M2U1MTUwMTc0NTI4ZjU2ZTZiMGVhY2ViN2RhNGYxNjUxMmU0YzkzODVhZGE2ZmNhYTNjM2U4";
            var jsonData = new DuoJsonRequestData
            {
                RequestData = TEST_JSONSTRING
            };
            
            var testSign = INSTANCE.SignRequest(HttpMethod.Post, "/Foo/BaR2/qux", TEST_TIME, jsonData, null);
            output.WriteLine($"Expected:    {expectedResult}");
            output.WriteLine($"Actual:      {testSign}");
            Assert.Equal(expectedResult, testSign);
        }
