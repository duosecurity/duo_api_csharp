...
{
    public class Tests_DuoSignatureV2(ITestOutputHelper output)
    {
        ...
        private static readonly DuoSignatureV2 INSTANCE = new(TEST_IKEY, TEST_SKEY, TEST_HOST, TEST_TIME);
        
        #region Generic Tests
        [Fact]
        public void Test_SignatureType_MatchesV2()
        {
            Assert.Equal(DuoSignatureTypes.Duo_SignatureTypeV2, INSTANCE.SignatureType);
        }
        ...
        public void Test_Signature()
        {
            ...
            var testSign = INSTANCE._GenerateSignature(HttpMethod.Post, "/Foo/BaR2/qux", TEST_TIME, requestdata);
        ...
        {
            const string expectedResult = "dGVzdF9pa2V5OjA1MDgwNjUwMzVhMDNiMmExZGUyZjQ1M2U2MjllNzkxZDE4MDMyOWUxNTdmNjVkZjZiM2UwZjA4Mjk5ZDQzMjFlMWM1YzdhN2M3ZWU2YjllNWZjODBkMWZiNmZiZjNhZDVlYjdjNDRkZDNiMzk4NWEwMmMzN2FjYTUzZWMzNjk4";
            var requestdata = new DuoParamRequestData
            {
                RequestData = new Dictionary<string, string> {
                    { "\u469a\u287b\u35d0\u8ef3\u6727\u502a\u0810\ud091\xc8\uc170", "\u0f45\u1a76\u341a\u654c\uc23f\u9b09\uabe2\u8343\u1b27\u60d0" },
            ...
            var testSign = INSTANCE.SignRequest(HttpMethod.Post, "/Foo/BaR2/qux", TEST_TIME, requestdata, null);
            output.WriteLine($"Expected:    {expectedResult}");
            output.WriteLine($"Actual:      {testSign}");
            Assert.Equal(expectedResult, testSign);
        }
